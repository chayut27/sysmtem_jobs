...
<nav aria-label="breadcrumb" class="mt-3">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="?page=system_province">จังหวัด</a></li>
            <li class="breadcrumb-item active" aria-current="page">แก้ไขจังหวัด : <?php echo $res[0]["name"];?></li>
        </ol>
    </div>
</nav>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                แก้ไขจังหวัด : <?php echo $res[0]["name"];?>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="../system_settings/do_province.php" method="POST">
