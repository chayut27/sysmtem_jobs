...
<nav aria-label="breadcrumb" class="mt-3">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">แก้ไขบริษัท : <?php echo $res[0]["name"]; ?></li>
        </ol>
    </div>
</nav>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                แก้ไขบริษัท : <?php echo $res[0]["name"]; ?>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    foreach ($res_business as $row) {
                                        ...
                                        <div class="custom-control custom-checkbox custom-control-inline">
                                            ...
                                            <?php if(in_array($row["id"],$arr_business)) echo "checked";  ?>>
                                ...
                                <div class="col-sm-10">
                                    <select name="province" id="province" class="form-control" required>
                                        ...
                                        foreach ($res_province as $row) {
                                            ?>
                                            <option value="<?php echo $row["id"]; ?>" <?php if($row["id"] == $res[0]["province"]){echo "selected";}?>><?php echo $row["name"]; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
