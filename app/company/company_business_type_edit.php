...
<nav aria-label="breadcrumb" class="mt-3">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="?page=jobs_function">ประเภทธุรกิจ</a></li>
            <li class="breadcrumb-item active" aria-current="page">แก้ไขประเภทธุรกิจ : <?php echo $res[0]["name"];?></li>
        </ol>
    </div>
</nav>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                            แก้ไขประเภทธุรกิจ : <?php echo $res[0]["name"];?>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="../company/do_business_type.php" method="POST">
